...
public class ClientController {
	...
	@FXML private JFXTextField serverPort;
	private String getPort;
	private static final AudioClip ALERT_AUDIOCLIPY = new AudioClip(ClientController.class.getResource("/Music/ringTone.wav").toString());
	 ...
	 */
	public void submitPort(ActionEvent event) {
	      getPort = serverPort.getText();
	}
	
	
	public void login() {
		Server.ALERT_AUDIOCLIP.stop();
	...
	public void sendMessage() {
		if (connected) {
			...
			try {
				ClientController.ALERT_AUDIOCLIPY.play();
				sOutput.writeObject(msg);
				txtUserMsg.setText("");
			} catch (IOException e) {
				display("Exception writing to server: " + e);
	...
	/**
	 * Sends message to server Used by TextArea txtUserMsg to handle Enter key event
	 */
